...
export const CartList = ({cart, checkLists, convertPrice, handleQuantity, handleRemove, handleCheckList}) => {
    return (
        <section className={styles.cart_product_list}>
        <input type="checkbox" onClick={(e) => {
          handleCheckList(e.currentTarget.checked, cart.id)
        }}
        checked={checkLists.includes(cart.id) ? true : false} //체크상태 유지를 위한 checked 설정
        />
